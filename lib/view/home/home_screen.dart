              ...
              SliverFillRemaining(
                ...
                child: SingleChildScrollView(
                  child: Column(children: [
                    ...
                    SpecialRestaurantMenu(title: "Tasty Offers", seeAllOption:true,onClick: (){}, restaurants:
                    [
                      RestaurantComponent(image: Image.asset('assets/images/burger.jpeg').image,
                          restaurantName: "Burger King",
                          deliveryTime: 45,
                          logo: Image.asset('assets/logos/Burger-King-Logo.png').image,
                          tags: ['American','Burger','Fast Food','Sandwiches'],
                          rating: 4.5
                      ...
                      RestaurantComponent(image: Image.asset('assets/images/burger.jpeg').image,
                        ...
                        deliveryTime: 45,
                        logo: Image.asset('assets/logos/Burger-King-Logo.png').image,
                        tags: ['American','Burger','Fast Food','Sandwich'],
                        rating: 4.5
                        ,offer: "20 EGP on orders above 80 EGP",),
                      RestaurantComponent(image: Image.asset('assets/images/burger.jpeg').image,
                        restaurantName: "Burger King",
                    ...
                    SpecialRestaurantMenu(title: "Trending Now",seeAllOption: false, onClick: (){}, restaurants:
                    [
                      RestaurantComponent(image: Image.asset('assets/images/burger.jpeg').image,
                        restaurantName: "Burger King",
                        deliveryTime: 45,
